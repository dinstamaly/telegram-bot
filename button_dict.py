from credit_info import (
    all_purposes, without_deposit, buy_product, elkart_visa, installment,
    ipoteka, ipo_bank, gov_ipo_comp, car_partners, auto_,
)
from deposit_info import (
    deposit_emerge, deposit_abundance,
    deposit_capital, deposit_pension, deposit_kid,
)
from info_text import cards_, contacts_, transfers_
from key_buttons import (
    tele_button, deposit_menu, credit1_menu, credit2_menu,
    credit3_menu, credit4_menu,
)
